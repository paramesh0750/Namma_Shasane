...
Namma Shasane is an AI-powered Android application developed using Kotlin and Android Studio. The application helps users identify heritage sites, view historical information, locate sites on maps, and report damaged heritage structures to authorities.
